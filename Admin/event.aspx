<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="event.aspx.cs" Inherits="Admin_UploadType" %>
                                                    ...
                                                    <tr>
                                                        <td valign="top" width="80%">
                                                            ...
                                                            <div class="form-group" style="position: relative;">
                                                                ...
                                                                <label class="col-md-1 col-xs-12 control-label">Time<span style="color: red;">*</span></label>
                                ...
                                <div class="panel-body panel-body-table">
                                    <asp:GridView ID="grdEvents" EmptyDataText="No Data Found" CssClass="table" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="8" OnPageIndexChanging="grdEvents_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Description" HeaderStyle-Width="500px" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <%#Eval("DescEnglish") %><br />
                                                    <%#Eval("DescHindi") %>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="File" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <a id="A1" runat="server" target="_blank" href='<%#Eval("Attachment")%>'><%#Eval("Text") %></a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
