<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="admin-documents.aspx.cs" Inherits="Admin_report" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="panelView" runat="server">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <asp:DropDownList ID="ddlDept" runat="server" OnSelectedIndexChanged="ddlDept_SelectedIndexChanged" AutoPostBack="true" class="btn btn-primary pull-left" Style="background-color: rgb(255, 255, 255); margin-right:10px; color:#000000;"><asp:ListItem></asp:ListItem></asp:DropDownList>
