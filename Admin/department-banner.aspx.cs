...
public partial class Admin_news_post : System.Web.UI.Page
{
        ...
        try
        {
            if (btnSave.Text == "Save")
            {
                ...
                else
                {
                    ...
                    ImageFileName = "DeptBanner_" + datevalue + ext;
                    ...
                    else
                    {
                        ...
                        DB_Status dbs = dba.sp_populateDataSet("SP_Banner_Department", 6, parameter, value);
                        string result = "";
    ...
    protected void FillBanners()
    {
        try
        {
            ...
            DB_Status dbs = dba.sp_populateDataSet("SP_Banner_Department", 2, parameter, value);
            if (dbs.OperationStatus.ToString() == "Success")
            {
                DataSet ds = dbs.ResultDataSet;
                if (ds.Tables.Count > 0)
