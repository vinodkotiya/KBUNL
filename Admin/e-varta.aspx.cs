...
public partial class Admin_news_post : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            hdfDept_Id.Value = "0";
            div_headTitle.InnerText = " Admin > E-Varta";
        }
        else if (Session["DeptID"] != null && Session["EmpName"] != null)
        {
            div_headTitle.InnerText = "Department : " + Convert.ToString(Session["deprt_name"]) + " > E-Varta";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (btnSave.Text == "Save")
            {
                ...
                {
                    displayMessage("Please upload E-Varta file", "error");
                }
                ...
                else
                {
                    ...
                    ImageFileName = "EVarta_" + datevalue + ext;
                    ImagePath = "Uploads/EVarta/" + ImageFileName;


                    CoverHasImage = true;
                    string ext1 = Path.GetExtension(fileUploadCover.FileName);
                    CoverImageFileName = "EVarta_Cover" + datevalue + ext1;
                    CoverImagePath = "Uploads/EVarta/" + CoverImageFileName;
                    ...
                    else
                    {
                        ...
                        DB_Status dbs = dba.sp_populateDataSet("SP_EVarta",6, parameter, value);
                        string result = "";
                        ...
                        if (result == "Success")
                        {
                            ...
                            displayMessage("EVarta successfully added", "info");
                            FillEMagazine();
                            hfEMagazineID.Value = "";
                            btnSave.Text = "Save";
                            panelAddNew.Visible = false;
                        ...
                        {
                            displayMessage("EVarta already exists", "error");
                        }
                    }
            ...
            else if (btnSave.Text == "Update")
            {
                ...
                else
                {
                    ...
                    if (fileUploadCover.HasFile)
                    {
                        ...
                        string datevalue = DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString();
                        CoverImageFileName = "EVarta_Cover" + datevalue + ext;
                    ...
                    {
                        string[] parameter = { "@Flag", "@EVartaID", "@DeptID","@Month", "@Year", "@CoverImage", "@AttachmentPath" };
                        ...
                        DB_Status dbs = dba.sp_populateDataSet("SP_EVarta", 7, parameter, value);
                        string result = "";
                        if (dbs.OperationStatus.ToString() == "Success")
                        {
                            DataSet ds = dbs.ResultDataSet;
                        ...
                        if (result == "Success")
                        {
                            ...
                            displayMessage("EVarta successfully updated", "info");
                            FillEMagazine();
                            hfEMagazineID.Value = "";
                            btnSave.Text = "Save";
                            panelAddNew.Visible = false;
    ...
    protected void FillEMagazine()
    {
        try
        {
            ...
            DB_Status dbs = dba.sp_populateDataSet("SP_EVarta", 2, parameter, value);
            if (dbs.OperationStatus.ToString() == "Success")
            {
                DataSet ds = dbs.ResultDataSet;
                if (ds.Tables.Count > 0)
    ...
    protected void Update_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string[] parameter = {"@Flag", "@EVartaID" };
