<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="Admin_news_post" %>
                                ...
                                <asp:Panel ID="panelAddNew" runat="server">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title"><strong>Add/Update</strong> Contact Offices</h3>
                                        </div>
                                                    ...
                                                    <tr>
                                                        <td valign="top" width="80%">                                                           
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-3 col-xs-12 control-label">Office Name</label>
                                                                <div class="col-md-6 col-xs-12">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                        <asp:TextBox ID="txtOfficeName" placeholder="Enter Office Name" class="form-control" runat="server" MaxLength="300"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div style="padding-top: .50%; margin-left: 10px">
                                                                    <asp:RequiredFieldValidator ID="RFV_OfficeName" runat="server" ErrorMessage="Office Name cannot be blank" ForeColor="Red" ControlToValidate="txtOfficeName"></asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>                                                            
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body panel-body-table">
                                            ...
                                            <asp:GridView ID="gridRecords" EmptyDataText="No Data Found" CssClass="table" runat="server" AutoGenerateColumns="False">
                                                <Columns>    
                                                    <asp:TemplateField HeaderText="Office Name" HeaderStyle-Width="300px">
                                                        <ItemTemplate>
