<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="reports-HOP.aspx.cs" Inherits="Admin_report" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                                        ...
                                        <ContentTemplate>
                                            <div class="form-horizontal">
                                                <div class="form-group" style="position: relative;">
                                                    <label class="col-md-3 col-xs-12 control-label">Report Post By<span style="color: red;">*</span></label>
                        ...
                        <asp:Panel ID="panelView" runat="server">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <asp:LinkButton ID="lbtn_AddNew_Document" runat="server" OnClick="lbtn_AddNew_Document_Click" class="btn btn-primary pull-right" Style="background-color: rgba(199, 15, 15, 0.9); margin-right: 10px;">Add New File</asp:LinkButton>
