...
public partial class Admin_internet_links : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            hdfDept_Id.Value = "0";
            div_headTitle.InnerText = "Admin >Internet Links";
        }
        else if (Session["DeptID"] != null && Session["EmpName"] != null)
        {
            div_headTitle.InnerText = "Department : " + Convert.ToString(Session["deprt_name"]) + " > Internet Links";
        ...
        try
        {
            if (btnSave.Text == "Save")
            {
                ...
                else
                {
                    ...
                    string[] value = { "Add",hdfDept_Id.Value, "Internet", txtLinkNameEnglish.Text.Trim(), txtLinkNameHindi.Text.Trim(), txtLinkURL.Text.Trim(),ddlUrlOpen.SelectedValue };
    ...
    protected void FillLinks()
    {
        try
        {
            ...
            string[] value = { "LoadForAdmin", "Internet",hdfDept_Id.Value };
