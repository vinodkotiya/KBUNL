<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="survey.aspx.cs" Inherits="Admin_survey" %>
                        ...
                        <div class="col-md-12 innerpage">
                            ...
                            <ContentTemplate>             
                                                            ...
                                                            <div class="form-group" style="position:relative;">
                                                                ...
                                                                <div class="col-md-6 col-xs-12">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <asp:TextBox ID="txtSurveyName" TextMode="MultiLine" placeholder="Enter survey title" class="form-control" runat="server" MaxLength="300" ></asp:TextBox>
                                                                    </div>
                                                                </div>
                                ...
                                <asp:Panel ID="panelView" runat="server">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <asp:LinkButton ID="lbtn_AddNew" runat="server" OnClick="lbtn_AddNew_Click" class="btn btn-primary pull-left" style="background-color: rgba(199, 15, 15, 0.9)">Add New Survey</asp:LinkButton>                                            
                                        </div>
                                        <div class="panel-body panel-body-table">   
                                            <asp:GridView ID="grdview" EmptyDataText="No Data Found" CssClass="table" runat="server" AutoGenerateColumns="False">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Survey Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSurveyName" runat="server" Text='<%#Eval("SurveyName")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Start Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <%#Eval("StartDate")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="End Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                           <%#Eval("EndDate")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="100px">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkEdit" CssClass="btn btn-default btn-rounded btn-sm" CausesValidation="false" CommandArgument='<%# Eval("SurveyId") %>' OnClick="lnkEdit_Click" runat="server"><span class="fa fa-pencil"></span></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Survey Questions" HeaderStyle-Width="150px">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkSurveyDetails" CssClass="btn btn-facebook btn-rounded bs-actionsbox"
                                                                CausesValidation="false" OnClick="ViewList_Click" CommandArgument='<%# Eval("SurveyId") %>' runat="server"> <span style="color:white"><span class="fa fa-link "></span>Questions</span></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="Response" HeaderStyle-Width="150px">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkSurveyResponse" CssClass="btn btn-facebook btn-rounded bs-actionsbox"
                                                                CausesValidation="false" OnClick="lnkSurveyResponse_Click" CommandArgument='<%# Eval("SurveyId") %>' runat="server"> <span style="color:white"><span class="fa fa-link "></span>Response</span></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
