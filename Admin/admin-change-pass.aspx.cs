   ...
   DB_Access dba = new DB_Access();
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string[] parameter = { "@count", "@Password", "NewPassword", "@UserName" };
                string[] value = { "1",obj.Encrypt(txtOP.Text.Trim()),obj.Encrypt(txtNP.Text.Trim()), hdfUserName.Value };
                DB_Status dbs = dba.sp_populateDataSet("SP_Admin_ChangePassword", 4, parameter, value);
                string str = "";
