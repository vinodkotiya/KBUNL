                                ...
                                <ContentTemplate>
                                    <div class="directorycontainer">
                                        <div class="filter">
                                            <table>
                                                <tr>
                                                    <td><label>Dept.Group</label></td>
                                                    <td><label>Dept.</label></td>
                                                    <td><label>Grade</label></td>
                                                    <td><label>Desig.</label></td>
                                                ...
                                                <tr>
                                                    <td>                                                        
                                                        <asp:DropDownList ID="ddlDepartmentGroup" AutoPostBack="true" CssClass="dropdown" runat="server" OnSelectedIndexChanged="ddlDepartmentGroup_SelectedIndexChanged" Width="120px"></asp:DropDownList>
                                                    </td>
                                                    <td>                                                        
                                                    ...
                                                    <td>                                                        
                                                        <asp:DropDownList ID="ddlGrade" AutoPostBack="true" CssClass="dropdown" runat="server" OnSelectedIndexChanged="ddlGrade_SelectedIndexChanged" Width="120px"></asp:DropDownList>
                                                    </td>
                                                    <td>                                                        
                                                    ...
                                                    <td>                                                        
                                                        <asp:TextBox ID="txtEmpNo" CssClass="txtbox" AutoPostBack="true" runat="server" OnTextChanged="txtEmpNo_TextChanged" Width="120px"></asp:TextBox>
                                                    </td>
                                                    <td>                                                        
                                                        <asp:TextBox ID="txtname" CssClass="txtbox" AutoPostBack="true" runat="server" OnTextChanged="txtname_TextChanged" Width="120px"></asp:TextBox>
                                                    </td>
                                                    <td>                                                        
                                                        <asp:DropDownList ID="ddlBloodGroup" AutoPostBack="true" CssClass="dropdown" runat="server" OnSelectedIndexChanged="ddlBloodGroup_SelectedIndexChanged" Width="120px"></asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                            ...
                                            <asp:Repeater ID="repeaterEmployee" runat="server">
                                                <ItemTemplate>
                                                    <div class="directorybox">
                                                        ...
                                                        <div class="designation"><%#Eval("Designation")%> (<%#Eval("Department")%>), <%#Eval("Level")%></div>
