                            ...
                            <tr>
                                ...
                                <td class="contentboxinner">
                                    ...
                                    <div class="innerbanner">
                                        ...
                                        <a class="active">Employee Welfare</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--Inner Banner - End -->
                                            ...
                                            <tr>
                                                ...
                                                <td class="adcol2">
                                                    ...
                                                    <div class="updates-container department">
                                                        <table class="filter">
                                                            <tr>
                                                                <td><a id="linkNews" style="border-right:none;">News & Updates</a></td>
                                                            </tr>                                                            
                                                        </table>
									...
									<div class="gallerycontainer">
										...
										<asp:Literal ID="ltrPhotoGallery" runat="server"></asp:Literal>
                                             ...
                                             <asp:LinkButton ID="lnkbtnViewAll" style="border:1px solid #6d6d6d;margin-bottom:10px;padding:5px;background-color:#f1f1f2;color:#333333;width:90px;" runat="server" Text="View All" OnClick="lnkbtnViewAll_Click" ></asp:LinkButton>
								</div>
                                    </div>
                                    <!--Photo Gallery - End-->
                                </td>
