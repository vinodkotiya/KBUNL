<%@ Page Language="C#" AutoEventWireup="true" CodeFile="directory-listview.aspx.cs" Inherits="directory" %>
                                                ...
                                                <td style="border:none;">
                                                    <div class="direcrorysearch">
                                                        ...
                                                        <div style="display: inline-block;">
                                                            <h5><a href="directory.aspx" style="border-radius: 15px 50px;padding-left: 10px;padding-right: 10px;color: #f7f7f7;font-weight: 600;background-color: #6e94b9;" >Advanced Search</a></h5>
                                                        </div>
                                                        <div style="display: inline-block;">
                                                            <h5><span style="border-radius: 15px 50px;padding-left: 10px;padding-right: 10px;color: #0f0808;font-weight: 600;background-color: #6eec95;" >
                                                              Login for personal details updation. New Employees may contact HR or OCMS for adding contact details</span></h5>
                                                        </div>
							                        </div>
