<%@ Page Language="C#" AutoEventWireup="true" CodeFile="directory-employee-information.aspx.cs" Inherits="directory" %>
                            ...
                            <div class="innerbanner">
                                ...
                                <div class="bannerpatch">
                                    ...
                                    <div class="breadcrumb">
                                        ...
                                        <a class="active">Employee Information</a>
                                    </div>
                                    ...
                                    <div class="directorycontent" style="margin-top: 30px; background-color:#ffffff;">
                                            ...
                                            <tr>
                                                <td style="border:none;">
                                                    <div class="direcrorysearch">
								                        <asp:TextBox ID="txtDirectorySearch" runat="server" placeholder="Search" AutoPostBack="true" OnTextChanged="btnDirectorySearch_Click"></asp:TextBox>
                                        ...
                                        <asp:GridView ID="gridDirectory" EmptyDataText="No Record Found" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="50" CssClass="gridview" PagerStyle-CssClass="gridviewpaging" OnPageIndexChanging="gridDirectory_PageIndexChanging">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="NTPC Joining Date">
                                                    <ItemTemplate>
                                                        <%#Eval("DOJ_atNTPC") %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Project Joining Date">
                                                    <ItemTemplate>
                                                        <%#Eval("DOJ_atProject") %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
