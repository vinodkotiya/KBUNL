...
public partial class WCCommon_WCTopBar : System.Web.UI.UserControl
{
    ...
    //public HyperLink MenuHome
    //{
    //    get { return home; }
    //}
    //public HyperLink MenuAbout
    //{
    //    get { return about; }
    //}

    //public HyperLink MenuDeaprtments
    //{
    //    get { return departments; }
    //}
    //public HyperLink MenuServices
    //{
    //    get { return services; }
    //}
    //public HyperLink MenuIntranetLinks
    //{
    //    get { return intranetlinks; }
    //}
    //public HyperLink MenuExternalLinks
    //{
    //    get { return externallinks; }
    //}
    //public HyperLink MenuDownloads
    //{
        ...
        try
        {
            ...
            else
            {
                if (txtUserName.Text == "admin")
                {
                    #region
                    string result = "";
                    string[] parameter = { "@count", "@UserId", "@Password" };
                    string[] value = { "1", txtUserName.Text, txtPassword.Text };
                    DB_Status dbs = dba.sp_populateDataSet("SP_Admin_Login", 3, parameter, value);
                ...
                else
                {
                    ...
                    else if (result == "ok")
                    {
                        ...
                        if (UserRole == "DeptAdmin")
                            Response.Redirect("DeptAdmin/dept-admin-home.aspx");
                        else if (UserRole == "Employee")
                            Response.Redirect("Employee/emp-home.aspx");
                        else
    ...
    protected bool push_mail(string UserEmailid, string Name, string Password)
    {
        ...
        try
        {
            string mailSubject = "Your Password at SRHQ Intranet Portal";
            ...
            mail.From = new MailAddress(EMailID, "SRHQ Intranet Portal");
    ...
    protected void lbtn_themeblack_Click(object sender, EventArgs e)
    {
        Session["Theme"] = "theme_black";
        Response.Redirect(Request.RawUrl);
    }
