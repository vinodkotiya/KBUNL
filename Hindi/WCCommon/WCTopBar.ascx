        ...
        <tr>
            <td class="logobox">
                ...
                <div class="direcrorysearch">
					<asp:TextBox ID="txtDirectorySearch" runat="server" placeholder="डायरेक्टरी सर्च" ValidationGroup="search"></asp:TextBox>
					<asp:Button ID="btnDirectorySearch" runat="server" Text="सर्च करें" OnClick="btnDirectorySearch_Click" CssClass="btn" ValidationGroup="search" AllowFocus="false"/>
				</div>
                <div style="text-align:left; font-size:14px; color:#6b6b6b; padding-top:5px;">
					<span style="border-radius: 15px 50px;    padding-left: 10px;    padding-right: 10px; color: #f7f7f7;    font-weight: 600;    background-color: #1565b2">तिथि-काल: <asp:label ID="lblDateTime" runat="server" Text=""></asp:label></span>
					</div>
            </td>
            ...
            <td class="linkbox">
                ...
                <div class="toplinks">
                    <a href="../login.aspx" class="login" target="_blank">लॉगिन</a>&nbsp;&nbsp;
                    हिंदी
                    <asp:LinkButton ID="lnkbtnMedium" runat="server" OnClick="lnkbtnMedium_Click" ><asp:Image ID="imgMedium" runat="server" /></asp:LinkButton>
                   
                    English
                </div>
                <div class="bottomlinks">
                    <a href="download.aspx">डाउनलोड</a>
                    <a href="reports.aspx">रिपोर्ट</a>
					<a href="search.aspx">आर्काइव</a>
                </div>
                <div style="text-align:right; font-size:14px; color:#6b6b6b; padding-top:5px;">
					<span style="border-radius: 15px 50px;    padding-left: 10px;    padding-right: 10px;color: #f7f7f7;    font-weight: 600;    background-color: #1565b2">आई पी एड्रेस: <asp:label ID="lblIPAddress" runat="server" Text=""></asp:label></span>
				</div>
            </td>
        </tr>
    </table>
