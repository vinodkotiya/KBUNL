                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="ourteam">
                                                            <a id="linkOurTeam" runat="server" class="home" target="_blank">हमारी टीम</a>
                                                        </div>
                                                    </td>
                                                    <td align="right">
								                ...
								                <div class="filter department">
                                                    <asp:Repeater ID="repeater_DocumentTab" runat="server">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="linktab" runat="server" Text='<%#Eval("DocTitleHindi") %>' CommandArgument='<%# Eval("DocID") %>' OnClick="View_Click"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
								                </div>
								                <div class="updates-content department">
									                <asp:Repeater ID="repeater_Document" runat="server">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="linkbtnFolder" runat="server" Text='<%#Eval("DocTitleHindi") %>' CssClass='<%#Eval("Extension") %>' visible='<%# Eval("IsDirectory").ToString() == "True" %>' OnClick="ViewChild_Click"></asp:LinkButton>
                                                            <a id="linkdocument_attachment" runat="server" href='<%#Eval("AttachmentURL_Admin")%>' visible='<%# Eval("IsAttachment").ToString() == "True" %>' target="_blank" class='<%#Eval("Extension") %>'><%#Eval("DocTitleHindi") %></a>
                                                            <a id="linkdocument_url" runat="server" href='<%#Eval("URL")%>' visible='<%# Eval("IsURL").ToString() == "True" %>' target="_blank" class='<%#Eval("Extension") %>'><%#Eval("DocTitleHindi") %></a>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                    <div style="text-align:right;">
                                                        <asp:LinkButton ID="linkBack" runat="server" OnClick="linkBack_Click" Text="पीछे जाएँ"></asp:LinkButton>
                                                    </div>
								                </div>
