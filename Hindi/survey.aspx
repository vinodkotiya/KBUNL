<%@ Page Language="C#" AutoEventWireup="true" CodeFile="survey.aspx.cs" Inherits="Hindi_survey" %>
                                    ...
                                    <div class="surveycontainer">
                                        <div class="surveycontent">
                                            ...
                                            <asp:Panel ID="pnlnotavailable" runat="server" Visible="false" CssClass="notavailable">
                                                <span>
                                                    वर्तमान में कोई सर्वेक्षण उपलब्ध नहीं है। <br/>
                                                    कृपया बाद में देखें।
                                                </span>
                                            </asp:Panel>
                                            ...
                                            <asp:Panel ID="pnlEmp" runat="server" Visible="false">
                                                ...
                                                <div class="empdata">
                                                    <p style="color:#466522;font-size:16px;padding:10px;">कर्मचारी संख्या और पासवर्ड के साथ लॉगिन करें</p>
                                                     <div class="inputbox">
