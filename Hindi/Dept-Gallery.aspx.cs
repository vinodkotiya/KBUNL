...
public partial class _Default : System.Web.UI.Page
{
    ...
    StringBuilder SearchCondition()
    {
        ...
        if (ddlYear.SelectedIndex > 0)
            sb.Append(" AND DATEPART(YYYY,GM.CreatedOn) ='" + Convert.ToString(ddlYear.SelectedItem.Text) + "' ");
        if (ddlMonth.SelectedIndex > 0)
            sb.Append(" AND DATENAME(MONTH,GM.CreatedOn)='" + Convert.ToString(ddlMonth.SelectedValue) + "' ");
        return sb;
    }
