...
<%@ Register Src="~/Hindi/WCCommon/MonthCalendar.ascx" TagPrefix="uc1" TagName="WCMonthlyCalendar" %>
<%@ Register Src="~/Hindi/WCCommon/YearCalendar.ascx" TagPrefix="uc1" TagName="WCYearlyCalendar" %>
                                                ...
                                                <td class="contentleft">
                                                    ...
                                                    <div class="rptfilter">
                                                        ...
                                                        <asp:DropDownList ID="ddlRptType" runat="server" CssClass="dropdownbox" AutoPostBack="true" OnSelectedIndexChanged="ddlRptType_SelectedIndexChanged">
                                                            <asp:ListItem Text="दैनिक" Value="Daily"></asp:ListItem>
                                                            <asp:ListItem Text="मासिक" Value="Monthly"></asp:ListItem>
                                                            <asp:ListItem Text="वार्षिक" Value="Yearly"></asp:ListItem>
                                                            <asp:ListItem Text="अन्य" Value="Others"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                    </hr>
                                                    ...
                                                    <!--Year Calendar - End-->
                                                     <br />
                                                    <a class="btn btn-primary pagebutton" href="reports.aspx">रिसेट</a>
                                                </td>
                                                <td class="reportdata">
                                                    <div style="float:right;margin:5px;">
                                                    <a id="lnkbtnBack" runat="server" class="btn btn-primary pull-right pagebutton">वापस जायें</a></div>
